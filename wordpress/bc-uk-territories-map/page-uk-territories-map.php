 ...
 */
$map_base = plugin_dir_url(__FILE__);
?><!DOCTYPE html>
...
<head>
  ...
  <link rel="stylesheet" href="<?php echo esc_url($map_base . 'index.css'); ?>" />
</head>
<body>
  <div id="root"></div>
  <script type="module" src="<?php echo esc_url($map_base . 'index.js'); ?>"></script>
</body>
</html>
